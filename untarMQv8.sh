...
## SCRIPT: untarMQv8.sh
##
## This script will un-tar the MQ package
##
###################################################################################
##
...
#########################################################################
#
# Create a folder and un-tar the MQ binary files
#
#########################################################################
function UntarMQBinaries() {
    #
    Log "Untaring MQ binary files ...."
    #
    ...
    if [[ ! -d ${mqTargetDir} ]]; then
        Log "Directory ${mqTargetDir} is missing ... creating"
...
###########################################################################
    ...
    UntarMQBinaries
    #
    Log "MQ untarMQv8 complete - please check logs in ${LOG_FILE}"
    exit 0
